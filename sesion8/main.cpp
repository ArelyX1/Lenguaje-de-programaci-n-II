...
int main(){
    ...
    set_libros.insert("ElJu2131jas");
    set_libros.insert("ElJujas");
    set_libros.insert("ElJujas");
    ...
    Libro *lbro5 = new Libro("ElJu2131jas", "123456789", "El li1231bro", "Fic123ción", 2022);
    ...
    cin >> dias >> mes >> anio;
    string fecha = format_date(valida_fecha(mes, dias, anio));
